...
Реализация при помощи средств OpenMP
...
Отличие второй лабораторной работы от первой заключается в использовании API OpenMP для параллельных вычислений. При сравнении результатов легко можно заметить, что параллельные вычислений приводят к более быстрому исполнению программы.

##### Результаты сравнения
![](output_data/result.png)

Из графика видно, что сложность все также близка к O(n^3)