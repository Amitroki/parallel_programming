...
Реализация при помощи средств MPI
...
Отличие второй лабораторной работы от первой заключается в использовании MPI для взаимодействия между процессами в ходе параллельных вычислений. Сравнение вычислений на собственном ноутбуке и суперкомпьютере "Сергей Королёв" представлено снизу (1 - мой ноутбук, 2 - суперкомпьютер).

##### Результаты сравнения
![](output_data/result.png)
![](output_data/result_korolev.png)